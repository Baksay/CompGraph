### РК1. Николаев. Cравнение производительности алгоритма заполнения многоугольников по граничным точками и метода из библиотеки pygame.
...
polygon_points = [
    (random.randint(0, width - 30), random.randint(0, height - 30)) for _ in range(10)
]
